      ...
      <div class="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div class="relative flex grid items-center grid-cols-2 ">
                  <a class="inline-flex items-center justify-start" href="{{ route('/') }}"><!-- Memanggil route '/' -->
                        <span class="ml-2 text-xl font-bold tracking-wide uppercase dark:text-gray-100 text-blue-700">
                              Beasiswa
                        </span>
                  </a>
                  <!-- Menu 720p -->
                  <ul class="items-center hidden space-x-8 lg:flex justify-end">
                        <li>
                              <a class="font-medium tracking-wide transition-colors duration-200 hover:text-teal-accent-400 dark:text-gray-100 text-blue-700"
